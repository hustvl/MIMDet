...
from ..common import (GeneralizedRCNNImageListForward,
                      get_fpn_model_parameters, lr_multiplier, train, mae_checkpoint)
...
dataloader.train.mapper.augmentations = [
    ...
    L(T.ResizeShortestEdge)(short_edge_length=(480, 512, 544, 576, 608, 640,
                                               736, 768, 800),
                            sample_style='choice',
                            max_size=1333),
]
...
train.output_dir = 'output/mimdet_vit_base_mask_rcnn_fpn_mr_0p5_800_1333_4xdec_coco_3x'
